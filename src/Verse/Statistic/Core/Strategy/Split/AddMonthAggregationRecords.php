...
class AddMonthAggregationRecords extends StatsModuleProto implements ModularStrategyInterface
{
    ...
    public function run()
    {
        ...
        foreach ($this->container->data as $statRecord) {
            ...
            $this->container->data[] = [
                    ...
                    StatRecord::TIME_SCALE => TimeScale::MONTH,
                ] + $statRecord;
        }
    ...
    private function _makeAggregateTime($time) {
        return (int)mktime(0, 0, 0, date('m', $time), 1, date('Y', $time));
    }
